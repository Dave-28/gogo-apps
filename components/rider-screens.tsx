...
import { C, FD, FB, FM, VFS_D, VFS_DT, VFS_DATA, PlusMinusBg, BatterySVG, Button, Pill, Caption, SwapCountdown, SlotMini, SwapStreak } from './shared';
  ...
  return (
    <div style={{ background: C.aub, height: '100%', color: C.white, position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '0 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative' }}>
        ...
        <span style={{ fontFamily: FM, fontSize: 11, color: 'rgba(255,255,255,0.55)' }}>v 2.4</span>
      </div>
      <div style={{ padding: '60px 28px 0', position: 'relative', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ fontFamily: FD, fontVariationSettings: VFS_D, fontWeight: 800, fontSize: 120, lineHeight: 0.86, letterSpacing: '-0.05em', textTransform: 'uppercase', marginTop: 18 }}>
          GO<br />
          <span style={{ color: C.mag }}>+</span><br />
          SWAP.
        </div>
        <div style={{ fontFamily: FB, fontSize: 16, lineHeight: 1.45, color: 'rgba(255,255,255,0.7)', marginTop: 22, maxWidth: 280 }}>
  ...
  return (
    <div style={{ background: C.bg, height: '100%', display: 'flex', flexDirection: 'column' }}>
      <AppTopBar
        ...
        trailing={<div style={{ width: 32, height: 32, borderRadius: 999, background: C.aub, color: C.white, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: FD, fontVariationSettings: VFS_D, fontWeight: 800, fontSize: 13 }}>M</div>}
      />
      <div style={{ flex: 1, overflowY: 'auto', padding: '4px 20px 24px' }}>
        <div style={{ background: C.aub, borderRadius: 20, padding: 22, color: C.white, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              ...
              <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 96, lineHeight: 0.9, letterSpacing: '-0.05em', fontVariantNumeric: 'tabular-nums', marginTop: 6 }}>
                28<span style={{ fontSize: 32, color: 'rgba(255,255,255,0.5)' }}>%</span>
              </div>
            </div>
          ...
          <div style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', marginTop: 18, paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.10)' }}>
            <div>
              ...
              <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 700, fontSize: 20, marginTop: 4 }}>~ 32 km</div>
            </div>
            <div>
              <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Pack</div>
              <div style={{ fontFamily: FM, fontWeight: 700, fontSize: 14, marginTop: 6 }}>GG-0421</div>
            </div>
            <div>
              <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Bike</div>
              <div style={{ fontFamily: FB, fontWeight: 600, fontSize: 14, marginTop: 4 }}>UAJ 027F</div>
            </div>
          </div>
        </div>

        <div style={{ marginTop: 12, background: C.mag, borderRadius: 16, padding: '16px 18px', display: 'flex', alignItems: 'center', gap: 14, color: C.white }}>
          <div style={{ width: 40, height: 40, borderRadius: 999, background: 'rgba(255,255,255,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: FD, fontVariationSettings: VFS_D, fontWeight: 800, fontSize: 22 }}>+</div>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontFamily: FB, fontWeight: 700, fontSize: 16, marginTop: 2 }}>Nakawa · 5/7 ready</div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 28, lineHeight: 1, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.03em' }}>
              4<span style={{ fontSize: 12, color: 'rgba(255,255,255,0.7)' }}> min</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 8 }}>
          {[['Swaps', '3', null], ['Distance', '64', 'km'], ['Spent', '18k', null]].map(([l, v, u]) => (
            <div key={l as string} style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, padding: 12 }}>
              <div style={{ fontSize: 10, fontWeight: 600, color: C.fg3, textTransform: 'uppercase', letterSpacing: '0.08em' }}>{l}</div>
              <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 28, color: C.aub, lineHeight: 1, marginTop: 6, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.02em' }}>
                {v}{u && <span style={{ fontSize: 12, color: C.fg3, marginLeft: 2 }}>{u}</span>}
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, overflow: 'hidden' }}>
          {[{ name: 'Nakawa', when: '08:42 · 58 sec', officer: 'Sarah', amt: '6,000' }, { name: 'Kabalagala', when: 'Yest · 64 sec', officer: 'Peter', amt: '6,000' }].map((s, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', borderBottom: i === 0 ? `1px solid ${C.hairline}` : 'none' }}>
              <BatterySVG size={26} charged={100} />
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 600, fontSize: 14 }}>{s.name}</div>
                <div style={{ fontSize: 11, color: C.fg3, marginTop: 1 }}>{s.when} · {s.officer}</div>
              </div>
              <div style={{ fontFamily: FM, fontSize: 12, color: C.fg2 }}>UGX {s.amt}</div>
            </div>
          ))}
        </div>
      </div>
  ...
  return (
    <div style={{ background: C.bg, height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column' }}>
        <div style={{ height: 220, position: 'relative', background: '#F2EAE7', backgroundImage: 'linear-gradient(to right, rgba(64,16,60,0.06) 1px, transparent 1px),linear-gradient(to bottom, rgba(64,16,60,0.06) 1px, transparent 1px)', backgroundSize: '32px 32px', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', left: 70, top: 162, width: 14, height: 14, borderRadius: 999, background: C.aub, border: `3px solid ${C.white}`, boxShadow: '0 0 0 8px rgba(64,16,60,0.16)' }} />
          <div style={{ position: 'absolute', left: 200, top: 56, transform: 'translateX(-50%)' }}>
            <div style={{ background: C.mag, color: C.white, padding: '4px 10px', borderRadius: 999, fontFamily: FB, fontWeight: 700, fontSize: 11, marginBottom: 4, textTransform: 'uppercase', letterSpacing: '0.05em', whiteSpace: 'nowrap' }}>NAKAWA · 4 MIN</div>
        ...
        <div style={{ flex: 1, background: C.white, marginTop: -18, borderTopLeftRadius: 22, borderTopRightRadius: 22, paddingTop: 8, overflowY: 'auto', boxShadow: '0 -8px 24px rgba(64,16,60,0.10)' }}>
          ...
          <div style={{ padding: '0 20px 8px', display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
            ...
            <span style={{ fontFamily: FM, fontSize: 11, color: C.fg3 }}>14 live</span>
          </div>
          {stations.map((s, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 14, padding: '14px 20px', borderTop: i === 0 ? `1px solid ${C.hairline}` : 'none', borderBottom: `1px solid ${C.hairline}`, background: s.recommended ? 'rgba(210,12,125,0.05)' : C.white }}>
              <BatterySVG size={28} charged={s.ready / s.total * 100} />
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <div style={{ fontFamily: FB, fontWeight: 700, fontSize: 15, color: C.fg1 }}>{s.name}</div>
                  {s.recommended && <Pill tone="mag">+ go</Pill>}
                </div>
                <div style={{ fontFamily: FB, fontSize: 12, color: C.fg3, marginTop: 2 }}>{s.dist} · {s.eta} · {s.officer}</div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 3, marginTop: 8 }}>
                  ...
                  <span style={{ fontFamily: FM, fontSize: 11, color: C.fg3, marginLeft: 6, fontVariantNumeric: 'tabular-nums' }}>{s.ready}/{s.total}</span>
                </div>
              </div>
  ...
  return (
    <div style={{ background: C.aub, height: '100%', display: 'flex', flexDirection: 'column', color: C.white, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '8px 20px 20px', display: 'flex', flexDirection: 'column', justifyContent: 'center', position: 'relative' }}>
        <div style={{ fontFamily: FM, fontSize: 11, color: 'rgba(255,255,255,0.5)', textAlign: 'center', textTransform: 'uppercase', letterSpacing: '0.12em' }}>
          Nakawa · bay 03 · #SW-8842
        </div>
        <div style={{ marginTop: 20 }}>
          <SwapCountdown secondsLeft={38} total={60} />
        </div>
        <div style={{ marginTop: 32, background: 'rgba(255,255,255,0.06)', borderRadius: 16, padding: '16px 18px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
          <div style={{ textAlign: 'center', flex: 1 }}>
            <BatterySVG size={44} charged={14} color="#7A5C68" />
            <div style={{ fontFamily: FB, fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.10em', marginTop: 8 }}>− RETURNED</div>
            <div style={{ fontFamily: FM, fontSize: 13, color: 'rgba(255,255,255,0.75)', marginTop: 2 }}>14%</div>
          </div>
          <div style={{ fontFamily: FD, fontVariationSettings: VFS_D, fontWeight: 800, fontSize: 36, color: C.mag, letterSpacing: '-0.02em' }}>→</div>
          <div style={{ textAlign: 'center', flex: 1 }}>
            <BatterySVG size={44} charged={100} color={C.mag} />
            <div style={{ fontFamily: FB, fontSize: 10, fontWeight: 700, color: C.mag, textTransform: 'uppercase', letterSpacing: '0.10em', marginTop: 8 }}>+ SWAPPING IN</div>
            <div style={{ fontFamily: FM, fontSize: 13, color: C.white, marginTop: 2 }}>100%</div>
          </div>
        </div>
        <div style={{ marginTop: 12, background: 'rgba(255,255,255,0.06)', borderRadius: 16, padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ width: 44, height: 44, borderRadius: 999, background: C.mag, color: C.white, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: FD, fontVariationSettings: VFS_D, fontWeight: 800, fontSize: 18 }}>SN</div>
          <div style={{ flex: 1 }}>
            <div style={{ fontFamily: FB, fontWeight: 600, fontSize: 15 }}>Sarah Namuli</div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.55)', marginTop: 2 }}>Swap officer · ★ 4.9</div>
          </div>
          <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 22, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.02em' }}>UGX&nbsp;6,000</div>
        </div>
  ...
  return (
    <div style={{ background: C.bg, height: '100%', display: 'flex', flexDirection: 'column' }}>
      <AppTopBar
        title="HISTORY"
        leading={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><polyline points="15 18 9 12 15 6" /></svg>}
        trailing={<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M3 6h18M6 12h12M9 18h6" /></svg>}
      />
      <div style={{ flex: 1, overflowY: 'auto', padding: '4px 20px 24px' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
          <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 96, lineHeight: 0.95, letterSpacing: '-0.05em', color: C.aub, fontVariantNumeric: 'tabular-nums', marginTop: 8 }}>87</div>
          <div>
            <div style={{ fontFamily: FB, fontWeight: 700, fontSize: 14, color: C.aub }}>swaps</div>
            <div style={{ fontSize: 11, color: C.fg3, marginTop: 2 }}>last 35 days</div>
          </div>
          <div style={{ marginLeft: 'auto', textAlign: 'right' }}>
            <div style={{ fontFamily: FM, fontSize: 11, color: C.success, fontWeight: 600 }}>+ 12 vs prior</div>
            <div style={{ fontFamily: FM, fontSize: 11, color: C.fg3, marginTop: 2 }}>UGX 522,000</div>
          </div>
        </div>
        ...
        <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, padding: 14 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginTop: 12, justifyContent: 'flex-end', fontFamily: FM, fontSize: 10, color: C.fg3 }}>
            <span>less</span>
            {[0, 1, 2, 3].map(v => (
              <div key={v} style={{ width: 10, height: 10, borderRadius: 2, background: v === 0 ? C.hairline : C.mag, opacity: v === 0 ? 1 : v === 1 ? 0.35 : v === 2 ? 0.7 : 1 }} />
            ))}
            <span>more</span>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginTop: 14 }}>
          <div style={{ background: C.aub, color: C.white, borderRadius: 12, padding: 14 }}>
            ...
            <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 36, lineHeight: 1, marginTop: 6, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.03em' }}>
          ...
          <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, padding: 14 }}>
            ...
            <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 36, lineHeight: 1, marginTop: 6, color: C.success, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.03em' }}>
        ...
        <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, overflow: 'hidden' }}>
          {swaps.map((s, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', borderBottom: i < swaps.length - 1 ? `1px solid ${C.hairline}` : 'none' }}>
              ...
              <div style={{ fontFamily: FM, fontSize: 13, color: C.fg2 }}>UGX {s.amt}</div>
            </div>
          ))}
        </div>
      </div>
...
export function WalletScreen() {
  return (
    <div style={{ background: C.bg, height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      />
      <div style={{ flex: 1, overflowY: 'auto', padding: '4px 20px 24px' }}>
        <div style={{ background: C.aub, borderRadius: 20, padding: 22, color: C.white, position: 'relative', overflow: 'hidden', minHeight: 200 }}>
          ...
          <div style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div>
              ...
              <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 56, lineHeight: 1, marginTop: 8, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.04em' }}>42,000</div>
              <div style={{ fontFamily: FM, fontSize: 12, color: 'rgba(255,255,255,0.55)', marginTop: 6 }}>UGX · ≈ 7 swaps</div>
            </div>
            {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <div style={{ position: 'relative', display: 'flex', justifyContent: 'space-between', marginTop: 22, paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.10)' }}>
            <div>
              ...
              <div style={{ fontFamily: FM, fontWeight: 700, fontSize: 13, marginTop: 4 }}>GG-2042-MK</div>
            </div>
            <div>
              <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Since</div>
              <div style={{ fontFamily: FB, fontWeight: 600, fontSize: 13, marginTop: 4 }}>Jan 2024</div>
            </div>
            <div>
              <div style={{ fontSize: 10, fontWeight: 600, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Tier</div>
              <div style={{ fontFamily: FB, fontWeight: 700, fontSize: 13, color: C.mag, marginTop: 4 }}>+ DAILY</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, padding: '14px 16px' }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
            <div>
              <div style={{ fontFamily: FB, fontWeight: 700, fontSize: 16, color: C.aub }}>4 swaps left</div>
              <div style={{ fontSize: 11, color: C.fg3, marginTop: 2 }}>Buy 10, get 1 free. Renews on swap #11.</div>
            </div>
            <div style={{ fontFamily: FD, fontVariationSettings: VFS_DATA, fontWeight: 800, fontSize: 24, color: C.aub, fontVariantNumeric: 'tabular-nums', letterSpacing: '-0.02em' }}>
              4<span style={{ fontSize: 12, color: C.fg3 }}>/10</span>
            </div>
          </div>
          <div style={{ display: 'flex', gap: 4, marginTop: 12 }}>
            {Array.from({ length: 10 }).map((_, i) => (
              <div key={i} style={{ flex: 1, height: 10, borderRadius: 2, background: i < 6 ? C.aub200 : C.mag }} />
            ))}
          </div>
        </div>
        ...
        <div style={{ background: C.white, border: `1px solid ${C.hairline}`, borderRadius: 12, overflow: 'hidden' }}>
          {[
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', borderBottom: i < 2 ? `1px solid ${C.hairline}` : 'none' }}>
              <div style={{ width: 40, height: 28, borderRadius: 6, background: p.active ? C.aub : C.hairline, color: p.active ? C.white : C.fg3, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: FD, fontVariationSettings: VFS_DT, fontWeight: 800, fontSize: 10, letterSpacing: '0.02em' }}>{p.badge}</div>
              <div style={{ flex: 1 }}>
                <div style={{ fontWeight: 600, fontSize: 14 }}>{p.name}</div>
                <div style={{ fontFamily: FM, fontSize: 11, color: C.fg3, marginTop: 1 }}>{p.sub}</div>
              </div>
              {p.active
